                        ...
                        <div class="bg-secondary rounded h-100 p-4">
							...
							<div class="row">
								...
								<div class="mb-3 col-xl-6">
                                    ...
                                    <input type="text"name="name" value="<?php echo $editdata[0]->name?>" class="form-control" id="exampleInputPassword1">
                                </div>
								
								<div class="mb-3 col-xl-6">
                                    <label for="exampleInputPassword1" class="form-label">Profession</label>
                                    <input type="text" class="form-control" value="<?php echo $editdata[0]->profession?>" name="profession" id="exampleInputPassword1">
                                </div>
