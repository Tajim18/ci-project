				  ...
				  <div class="col-sm-12 col-xl-12">
                        <div class="bg-secondary rounded h-100 p-4">
							...
							<div class="row">
								...
								<img src="<?phpecho base_url()?>uploads<?php echo $editdata[0]->image?>">
								...
								<div class="mb-3 col-xl-6">
                                    ...
                                    <input type="text" name="heading" value="<?php echo $editdata[0]->heading; ?>" class="form-control" id="exampleInputPassword1">
                                </div>
								
									<div class="mb-3 col-xl-6">
                                    <label for="exampleInputPassword1" class="form-label">Url</label>
                                    <input type="text" name="url" value="<?php echo $editdata[0]->url; ?>" class="form-control" id="exampleInputPassword1">
                                </div>
